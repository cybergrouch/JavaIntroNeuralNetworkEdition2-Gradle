...
public class PlayerRandom implements Player {
     ...
     *
     * @param board  <code>Board</code> representation of the current game state.
     * @param prev   <code>Move</code> representing the previous move in the the
     *               game.
     * @param player <code>int</code> representing the pieces this

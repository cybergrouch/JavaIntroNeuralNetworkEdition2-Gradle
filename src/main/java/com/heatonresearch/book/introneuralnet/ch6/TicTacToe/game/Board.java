...
public class Board {
     ...
     *
     * @param board <code>byte[][]</code> board to copy.
     ...
     * is empty or not.
     *
     * @param move <code>Move</code> to check position of.
     ...
     *
     * @param board  <code>byte[][]</code> board to check.
     * @param player <code>byte</code> either <code>TicTacToe.NOUGHTS</code> or
     ...
     *
     * @param board <code>byte[][]</code> of board to perform move on.
     * @param m     <code>Move</code> to perform.

...
public class Move {
     ...
     *
     * @param x     <code>int</code> x-coordinate of this move.
     * @param y     <code>int</code> y-coordinate of this move.
     * @param color <code>int</code> type of piece played by this player (either

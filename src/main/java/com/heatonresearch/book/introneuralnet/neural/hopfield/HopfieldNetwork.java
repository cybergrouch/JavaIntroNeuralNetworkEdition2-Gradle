...
public class HopfieldNetwork {
     ...
     * @throws HopfieldException The pattern caused a matrix math error.
     */
     ...
     *
     * @param pattern The pattern to train on.
     * @throws HopfieldException The pattern size must match the size of this neural network.
     */

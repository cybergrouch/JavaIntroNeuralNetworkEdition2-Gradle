...
public class SpiderParseHTML extends ParseHTML {
     ...
     *
     * @param base   The URL that is being parsed, this is used for
     *               relative links.
     * @param is     The InputStream being parsed.
     * @param spider The Spider that is parsing.
     * @throws WorkloadException An error occurred with the workload
     *                           management.
     */
     ...
     * @param type What type of link this is.

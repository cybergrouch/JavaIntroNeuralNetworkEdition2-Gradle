...
public class RepeatableStatement {
    ...
    public class Results {
         ...
         *
         * @param statement The PreparedStatement for these results.
     ...
     * PreparedStatements.
     *
     * @param manager The manager that created this statement.
     ...
     *
     * @param parameters The parameters for this SQL.
     * @throws WorkloadException Thrown if the SQL cannot be executed, and
     ...
     * @throws SQLException Thrown if the statement could not be
     *                      obtained.
     */
     ...
     *
     * @param stmt The statement that is to be released.
     */

...
public class SQLWorkloadManager implements WorkloadManager {
     ...
     * Clear the workload.
     *
     * @throws WorkloadException An error prevented the workload from being
     *                           cleared.
     */
     ...
     * WorkloadException.
     *
     * @param url A String to convert into a URL.
     * @return The URL.
     * @throws WorkloadException Thrown if, The String could not be
     *                           converted.
     */
     ...
     *
     * @param url The URL to get the depth of.
     * @return The depth of the specified URL.
     * @throws WorkloadException Thrown if the depth could not be found.
     */
     ...
     *
     * @param url The URL to seek the source for.
     * @return The source of the specified URL.
     * @throws WorkloadException Thrown if the source of the specified URL
     *                           could not be found.
     */
     ...
     * @throws WorkloadException Thrown if the next URL could not be obtained.
     */
     ...
     * @throws WorkloadException Thrown if there is an error setting up the
     *                           workload manager.
     */
     ...
     *
     * @param url The URL that had an error.
     * @throws WorkloadException Thrown if the specified URL could not be
     *                           marked.
     */
     ...
     * @throws WorkloadException Thrown if the workload manager was unable to
     ...
     *
     * @throws WorkloadException Thrown if we were unable to resume the
     *                           processing.
     */
     ...
     * @param unit What time unit is being used.
     */
     ...
     * units.
     * @throws WorkloadException Thrown if there was an error determining if
     ...
     *
     * @param url The URL to compute the hash for.
     ...
     * @param column The column to get the size for.
     ...
     * @throws WorkloadException Thrown if unable to obtain the host name.
     */
     ...
     * @param require Should an exception be thrown if the host is
     *                not located.
     * @return The id of the specified host name.
     * @throws WorkloadException Thrown if the host id is not found, and is
     *                           required.
     ...
     *
     * @param url     The URL that specifies the host name to
     *                lookup.
     * @param require Should an exception be thrown if the host is
     *                not located.
     * @return The id of the specified host name.
     ...
     * @throws WorkloadException Thrown if unable to obtain a URL.
     */
     ...
     * @param require Should an exception be thrown if the workload
     *                is not located.
     ...
     * @throws WorkloadException Thrown if the host cannot be marked.
     */
     ...
     *
     * @throws InstantiationException Thrown if the database driver could not be
     *                                opened.
     * @throws IllegalAccessException Thrown if the database driver can not be
     *                                acccessed.
     * @throws ClassNotFoundException Thrown if the wrong type of class is
     *                                returned.
     * @throws WorkloadException      Thrown if the database cannot be opened.
     * @throws SQLException           Thrown if a SQL error occurs.
     */
     ...
     * @param status What to set the status to.
     * @throws WorkloadException Thrown if the status cannot be set.
     * @throws SQLException      Thrown if a SQL error occurs.
     */
     ...
     *
     * @throws WorkloadException Thrown if the open fails.
     */

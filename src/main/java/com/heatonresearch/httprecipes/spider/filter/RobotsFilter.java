...
public class RobotsFilter implements SpiderFilter {
     ...
     * @param userAgent The user agent being used by the spider. Leave
     *                  null for default.
     ...
     * robots.txt file.
     *
     * @param str The line that was read in.
     * @throws MalformedURLException Thrown if a bad URL is found.
     */

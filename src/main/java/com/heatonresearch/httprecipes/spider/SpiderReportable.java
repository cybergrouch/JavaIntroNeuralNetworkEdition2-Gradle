...
public interface SpiderReportable {
     ...
     * process a new host.
     *
     * @param host The new host that is about to be processed.
     ...
     * object.
     *
     * @param spider The spider that will be working with this
     *               object.
     */
     ...
     * @param type   The type of link this URL is.
     ...
     * @throws IOException Thrown if an IO error occurs while processing
     *                     the page.
     */
     ...
     * @param parse An object that will allow you you to parse the
     *              HTML on this page.
     * @throws IOException Thrown if an IO error occurs while processing
     *                     the page.
     */

...
public class Spider {
     ...
     * report progress to.
     *
     * @param report  A class that implements the SpiderReportable
     *                interface, that will receive information that
     *                the spider finds.
     * @param timeout How many miliseconds to wait for data.
     * @throws ClassNotFoundException Thrown if an error occurs while creating the
     *                                workload manager.
     * @throws IllegalAccessException Thrown if an error occurs while creating the
     *                                workload manager.
     * @throws InstantiationException Thrown if an error occurs while creating the
     *                                workload manager.
     * @throws WorkloadException      Exception thrown if there are any issues with
     *                                the workload.
     */
     ...
     * @throws WorkloadException    Exception thrown if there are any issues with
     *                              the workload.
     * @throws InterruptedException Called if any blocking operation is
     *                              interrupted.
     */
